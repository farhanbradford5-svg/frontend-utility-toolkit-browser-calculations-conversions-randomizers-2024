...
export const ALL_TOOLS: Tool[] = [
  ...
  // Finance — batch 3
  { slug: 'rule-of-72', name: 'Rule of 72 Calculator', category: 'calculators', subcategory: 'finance', description: 'Estimate how long it takes for an investment to double using the Rule of 72.', keywords: ['rule of 72', 'doubling time', 'interest', 'investment', 'compound'], path: '/calculators/finance/rule-of-72' },
  { slug: 'apr-calculator', name: 'APR Calculator', category: 'calculators', subcategory: 'finance', description: 'Calculate the Annual Percentage Rate (APR) of a loan including fees.', keywords: ['apr', 'annual percentage rate', 'loan', 'interest', 'fees', 'true cost'], path: '/calculators/finance/apr-calculator' },
  { slug: 'loan-comparison', name: 'Loan Comparison Calculator', category: 'calculators', subcategory: 'finance', description: 'Compare two loans side-by-side to find the better deal.', keywords: ['loan comparison', 'compare loans', 'monthly payment', 'total interest', 'best loan'], path: '/calculators/finance/loan-comparison' },
  { slug: 'investment-doubling-time', name: 'Investment Doubling Time', category: 'calculators', subcategory: 'finance', description: 'See how quickly your investment doubles across different interest rates.', keywords: ['doubling time', 'investment', 'rate of return', 'rule 72', 'compound growth'], path: '/calculators/finance/investment-doubling-time' },
  { slug: 'payback-period', name: 'Payback Period Calculator', category: 'calculators', subcategory: 'finance', description: 'Calculate how long it takes to recover an initial investment from cash flows.', keywords: ['payback period', 'investment recovery', 'cash flow', 'roi', 'break even'], path: '/calculators/finance/payback-period' },
  { slug: 'reverse-discount', name: 'Reverse Discount Calculator', category: 'calculators', subcategory: 'finance', description: 'Find the original price before a discount was applied.', keywords: ['reverse discount', 'original price', 'sale price', 'discount', 'before sale'], path: '/calculators/finance/reverse-discount' },

  // Date & Time — batch 3
  { slug: 'time-with-breaks', name: 'Time Duration with Breaks', category: 'calculators', subcategory: 'date-time', description: 'Calculate total time worked after subtracting break time.', keywords: ['time duration', 'breaks', 'work hours', 'shift time', 'net hours'], path: '/calculators/date-time/time-with-breaks' },
  { slug: 'shift-calculator', name: 'Shift Calculator', category: 'calculators', subcategory: 'date-time', description: 'Calculate weekly shift hours and earnings from daily start/end times.', keywords: ['shift calculator', 'work schedule', 'weekly hours', 'pay calculator', 'timesheet'], path: '/calculators/date-time/shift-calculator' },
  { slug: 'payroll-hours', name: 'Payroll Hours Calculator', category: 'calculators', subcategory: 'date-time', description: 'Calculate total payroll hours and gross pay from time entries.', keywords: ['payroll hours', 'timesheet', 'gross pay', 'work hours', 'hourly wage'], path: '/calculators/date-time/payroll-hours' },
  { slug: 'overtime-calculator', name: 'Overtime Calculator', category: 'calculators', subcategory: 'date-time', description: 'Calculate regular and overtime pay based on hours worked and rate.', keywords: ['overtime', 'overtime pay', 'time and a half', 'regular pay', 'paycheck'], path: '/calculators/date-time/overtime-calculator' },

  // Geometry — batch 3
  { slug: 'rectangle-diagonal', name: 'Rectangle Diagonal Calculator', category: 'calculators', subcategory: 'geometry', description: 'Calculate the diagonal, area, and perimeter of a rectangle.', keywords: ['rectangle diagonal', 'diagonal length', 'pythagorean', 'rectangle area', 'geometry'], path: '/calculators/geometry/rectangle-diagonal' },
  { slug: 'arc-length', name: 'Arc Length Calculator', category: 'calculators', subcategory: 'geometry', description: 'Calculate the arc length of a circle given radius and central angle.', keywords: ['arc length', 'circle arc', 'radius', 'central angle', 'sector'], path: '/calculators/geometry/arc-length' },
  { slug: 'sector-area', name: 'Sector Area Calculator', category: 'calculators', subcategory: 'geometry', description: 'Calculate the area of a sector (pie slice) of a circle.', keywords: ['sector area', 'circle sector', 'pie slice', 'radius', 'central angle'], path: '/calculators/geometry/sector-area' },
  { slug: 'triangle-solver', name: 'Triangle Solver', category: 'calculators', subcategory: 'geometry', description: 'Solve a triangle from known sides or angles (SSS or SAS).', keywords: ['triangle solver', 'law of cosines', 'triangle angles', 'triangle sides', 'sss sas'], path: '/calculators/geometry/triangle-solver' },

  // Statistics — batch 3
  { slug: 'standard-error', name: 'Standard Error Calculator', category: 'calculators', subcategory: 'statistics', description: 'Calculate the standard error of the mean from a dataset.', keywords: ['standard error', 'se', 'mean error', 'statistics', 'sample mean'], path: '/calculators/statistics/standard-error' },
  { slug: 'percent-change', name: 'Percentage Change Calculator', category: 'calculators', subcategory: 'statistics', description: 'Calculate the percentage increase or decrease between two values.', keywords: ['percentage change', 'percent increase', 'percent decrease', 'growth rate', 'change'], path: '/calculators/statistics/percent-change' },

  // Data — batch 3
  { slug: 'bitrate', name: 'Bitrate Calculator', category: 'calculators', subcategory: 'data', description: 'Calculate the bitrate of a video or audio file from its size and duration.', keywords: ['bitrate', 'video bitrate', 'audio bitrate', 'mbps', 'kbps', 'file size'], path: '/calculators/data/bitrate' },
  { slug: 'upload-time', name: 'Upload Time Calculator', category: 'calculators', subcategory: 'data', description: 'Calculate how long it takes to upload a file at a given upload speed.', keywords: ['upload time', 'upload speed', 'file size', 'internet speed', 'transfer time'], path: '/calculators/data/upload-time' },
  { slug: 'ordinal-number', name: 'Ordinal Number Converter', category: 'calculators', subcategory: 'data', description: 'Convert any number to its ordinal form (1st, 2nd, 3rd, etc.).', keywords: ['ordinal number', '1st 2nd 3rd', 'ordinal suffix', 'number converter', 'st nd rd th'], path: '/calculators/data/ordinal-number' },
  { slug: 'number-formatter', name: 'Number Formatter', category: 'calculators', subcategory: 'data', description: 'Format numbers with locale-specific separators, scientific notation, and word form.', keywords: ['number formatter', 'number format', 'locale', 'scientific notation', 'number words'], path: '/calculators/data/number-formatter' },

  // Health — batch 3
  { slug: 'steps-to-calories', name: 'Steps to Calories Calculator', category: 'calculators', subcategory: 'health', description: 'Estimate calories burned from step count and body weight.', keywords: ['steps to calories', 'pedometer calories', 'walking steps', 'daily steps', 'calorie burn'], path: '/calculators/health/steps-to-calories' },
  { slug: 'walking-calories', name: 'Walking Calories Calculator', category: 'calculators', subcategory: 'health', description: 'Calculate calories burned while walking based on weight, speed, and duration.', keywords: ['walking calories', 'calorie burn walking', 'met value', 'exercise calories', 'walk'], path: '/calculators/health/walking-calories' },

  // Randomizers — batch 3
  { slug: 'random-date', name: 'Random Date Generator', category: 'randomizers', subcategory: 'randomizers', description: 'Generate random dates within a specified date range.', keywords: ['random date', 'date generator', 'random calendar', 'date range', 'pick date'], path: '/randomizers/random-date' },
  { slug: 'random-time', name: 'Random Time Generator', category: 'randomizers', subcategory: 'randomizers', description: 'Generate random times of day in 12-hour or 24-hour format.', keywords: ['random time', 'time generator', 'random clock', '12 hour 24 hour', 'pick time'], path: '/randomizers/random-time' },
  { slug: 'random-decimal', name: 'Random Decimal Generator', category: 'randomizers', subcategory: 'randomizers', description: 'Generate random decimal numbers within a custom range and precision.', keywords: ['random decimal', 'random float', 'decimal number', 'random fraction', 'precision'], path: '/randomizers/random-decimal' },
  { slug: 'random-yes-no', name: 'Random Yes or No', category: 'randomizers', subcategory: 'randomizers', description: 'Get a random yes or no decision with adjustable probability.', keywords: ['random yes no', 'yes or no', 'decision maker', 'flip coin', 'random choice'], path: '/randomizers/random-yes-no' },
  { slug: 'random-letter', name: 'Random Letter Generator', category: 'randomizers', subcategory: 'randomizers', description: 'Generate random letters from the alphabet with case and uniqueness options.', keywords: ['random letter', 'alphabet generator', 'random character', 'letter picker', 'a-z'], path: '/randomizers/random-letter' },

  // Converters — batch 3
  { slug: 'kg-to-lbs', name: 'Kg to Lbs Converter', category: 'converters', subcategory: 'weight', description: 'Convert kilograms to pounds, ounces, stones, and grams instantly.', keywords: ['kg to lbs', 'kilograms to pounds', 'weight converter', 'kg lbs', 'mass conversion'], path: '/converters/weight/kg-to-lbs' },
  { slug: 'lbs-to-kg', name: 'Lbs to Kg Converter', category: 'converters', subcategory: 'weight', description: 'Convert pounds to kilograms, grams, stones, and ounces instantly.', keywords: ['lbs to kg', 'pounds to kilograms', 'weight converter', 'lbs kg', 'mass conversion'], path: '/converters/weight/lbs-to-kg' },
  { slug: 'gallon-to-liter', name: 'Gallon to Liter Converter', category: 'converters', subcategory: 'volume', description: 'Convert US gallons to liters or liters to gallons instantly.', keywords: ['gallon to liter', 'liters to gallons', 'volume converter', 'us gallon', 'liquid volume'], path: '/converters/volume/gallon-to-liter' },
